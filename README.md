# ![LOGO](logo.png) MLB v3 Scores **flow**ground Connector

## Description

A generated **flow**ground connector for the MLB v3 Scores API (version 1.0).

Generated from: https://api.apis.guru/v2/specs/fantasydata.net/mlb-v3-scores/1.0/swagger.json<br/>
...
**flow**ground :- Telekom iPaaS / fantasydata-net-mlb-v-3-scores-connector<br/>
